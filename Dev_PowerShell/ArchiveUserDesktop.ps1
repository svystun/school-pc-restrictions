...
#Remove-Item "C:\Users\Àäìèíèñòðàòîð\Desktop\test\*" -Recurse -Force
#Remove-Item "C:\Users\Àäìèíèñòðàòîð\Desktop\test\*" -Exclude "1.txt","2.txt" -Recurse -Force
...
#$result = [System.Windows.MessageBox]::Show($rules, $title, "YesNo", "Information", "Yes")
#Write-Host $result
